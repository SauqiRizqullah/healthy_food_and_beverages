package com.personal.healthyfoodandbeverages.utils;
...
public class TransactionDetailCustomId implements IdentifierGenerator {
    ...
    public Object generate(SharedSessionContractImplementor sharedSessionContractImplementor, Object o) {
        ...
        String query = "SELECT COALESCE(MAX(CAST(SUBSTRING(trx_detail_id, 7) AS INTEGER)), 0) FROM t_transaction_detail";
